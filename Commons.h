...
typedef enum { SPEED_M_GROWTH, SPEED_C, MAX_AGE, AGE_OF_MATURE, AGE_OF_OLD, SPEED_OLD_GROWTH, FAST_GENE, WEIGHT, VISIBILITY_C, VISIBILITY_GENE, PREGNANCY_TIME,
	VISIBILITY_M_GROWTH, VISIBILITY_OLD_GROWTH, PREGNANCY_GENE, STRENGTH_C, STRENGTH_M_GROWTH, STRENGTH_OLD_GROWTH, AGILITY_C, AGILITY_M_GROWTH, AGILITY_OLD_GROWTH, LIFESPAN
} PARAM_TYPE;


inline float CREATURES_TABLE[2][21] = {
	{0.5, 0.2, 100, 7, 55, -0.2, 0.2, 3, 2, 2, 5, 3, -2, 2, 0, 3, -1, 6, 4, -3, 70}, //RABBIT
	{ 0.5, 0.2, 70, 8, 50, -0.2, 0.2, 7, 3, 3, 7, 7, -2, 3, 2, 5, -2, 3, 4, -3, 85} //FOX
};
